...
def extract_all_citations(sentences: List[str]) -> List[str]:
    """
    Extract all citations from all sentences without keyword filtering.
    Returns a deduplicated, alphabetically ordered list of citations.
    """
    ...
    ordered_citations.sort(key=lambda x: x.lower())
